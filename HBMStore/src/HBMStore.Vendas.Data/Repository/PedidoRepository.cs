...
namespace HBMStore.Vendas.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public async Task<PedidoItem> ObterPedidoItemPorPedidoId(Guid pedidoId, Guid produtoId)
        {
        ...
        public void AtualizarPedidoItem(PedidoItem pedidoItem)
        {
