...
namespace HBMStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        {
            bool estoqueDebitado = await _estoqueService.DebitarEstoque(id, quantidade);
        ...
        {
            bool estoqueReposto = await _estoqueService.ReporEstoque(id, quantidade);
